...
$string['enrolbtnlogin'] = 'Enrol button links to login page';
...
$string['excludefield'] = 'Custom sections to hide from display';
$string['excludefield_desc'] = 'Comma-separated custom field shortnames to hide:
<pre>mb2section,mb2section2,mb2section3,mb2section4,mb2section5</pre>';
...
$string['navblocks'] = '"Navigation" and "Administration" block';
